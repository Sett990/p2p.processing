...
const getCalcSection = (payout, section) => payout?.calc_meta?.[section] ?? {};
const getCalcValue = (payout, section, key) => payout?.calc_meta?.[section]?.[key] ?? null;
const getCalcCurrency = (payout) => payout?.calc_meta?.exchange?.currency ?? 'USDT';
const getCalcAmountCurrency = (payout) => payout?.calc_meta?.inputs?.amount_currency ?? payout?.amount?.currency ?? 'RUB';
                                                        ...
                                                        <div class="card-body text-sm space-y-4">
                                                                ...
                                                                <div class="space-y-2">
                                                                    ...
                                                                    <div class="flex items-center justify-between">
                                                                        ...
                                                                        <span class="font-semibold">
                                                                            {{ formatCalcMoney(getCalcValue(payout, 'inputs', 'amount_fiat'), getCalcAmountCurrency(payout)) }}
                                                                        </span>
                                                                    </div>
                                                                    <div class="flex items-center justify-between">
                                                                        <span class="text-xs text-base-content/60">Комиссия всего</span>
                                                                        <span class="font-semibold">{{ getCalcValue(payout, 'inputs', 'total_commission_rate') ?? '—' }}%</span>
                                                                    </div>
                                                                    <div class="flex items-center justify-between">
                                                                        <span class="text-xs text-base-content/60">Комиссия трейдера</span>
                                                                        <span class="font-semibold">{{ getCalcValue(payout, 'inputs', 'trader_commission_rate') ?? '—' }}%</span>
                                                                    </div>
                                                                    <div class="flex items-center justify-between">
                                                                        <span class="text-xs text-base-content/60">Комиссия тимлида</span>
                                                                        <span class="font-semibold">{{ getCalcValue(payout, 'inputs', 'teamlead_commission_rate') ?? '—' }}%</span>
                                                                    </div>
                                                                    <div class="flex items-center justify-between">
                                                                        <span class="text-xs text-base-content/60">Комиссия сервиса</span>
                                                                        <span class="font-semibold">{{ getCalcValue(payout, 'inputs', 'service_commission_rate') ?? '—' }}%</span>
                                                                    </div>
                                                                </div>
                                                                <div class="space-y-2">
                                                                    <div class="text-xs uppercase text-base-content/50">Курс</div>
                                                                    <div class="flex items-center justify-between">
                                                                        ...
                                                                        <span class="font-semibold">{{ getCalcValue(payout, 'exchange', 'market') ?? '—' }}</span>
                                                                    </div>
                                                                    <div class="flex items-center justify-between">
                                                                        <span class="text-xs text-base-content/60">Цена</span>
                                                                        <span class="font-semibold">
                                                                            {{ formatCalcMoney(getCalcValue(payout, 'exchange', 'price'), getCalcCurrency(payout)) }}
                                                                        </span>
                                                                    </div>
                                                                    <div class="flex items-center justify-between">
                                                                        <span class="text-xs text-base-content/60">Зафиксирован</span>
                                                                        <DateTime :data="getCalcValue(payout, 'exchange', 'fixed_at')" simple class="justify-start font-semibold" />
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                                                <div class="space-y-2">
                                                                    ...
                                                                    <div class="flex items-center justify-between">
                                                                        ...
                                                                        <span class="font-semibold">{{ formatCalcMoney(getCalcValue(payout, 'outputs', 'usdt_body'), 'USDT') }}</span>
                                                                    </div>
                                                                    <div class="flex items-center justify-between">
                                                                        <span class="text-xs text-base-content/60">Комиссия всего</span>
                                                                        <span class="font-semibold">{{ formatCalcMoney(getCalcValue(payout, 'outputs', 'total_fee'), 'USDT') }}</span>
                                                                    </div>
                                                                    <div class="flex items-center justify-between">
                                                                        <span class="text-xs text-base-content/60">Комиссия трейдера (база)</span>
                                                                        <span class="font-semibold">{{ formatCalcMoney(getCalcValue(payout, 'outputs', 'trader_fee_base'), 'USDT') }}</span>
                                                                    </div>
                                                                    <div class="flex items-center justify-between">
                                                                        <span class="text-xs text-base-content/60">Комиссия трейдера (итог)</span>
                                                                        <span class="font-semibold">{{ formatCalcMoney(getCalcValue(payout, 'outputs', 'trader_fee'), 'USDT') }}</span>
                                                                    </div>
                                                                    <div class="flex items-center justify-between">
                                                                        <span class="text-xs text-base-content/60">Комиссия тимлида</span>
                                                                    ...
                                                                    <div class="flex items-center justify-between">
                                                                        ...
                                                                        <span class="font-semibold">{{ formatCalcMoney(getCalcValue(payout, 'outputs', 'service_fee_base'), 'USDT') }}</span>
                                                                    </div>
                                                                    <div class="flex items-center justify-between">
                                                                ...
                                                                <div class="space-y-2">
                                                                    <div class="text-xs uppercase text-base-content/50">Движение средств</div>
                                                                    <div class="flex items-center justify-between">
                                                                        <span class="text-xs text-base-content/60">Списано у мерчанта</span>
                                                                        <span class="font-semibold">{{ formatCalcMoney(getCalcValue(payout, 'outputs', 'merchant_debit'), 'USDT') }}</span>
                                                                    </div>
                                                                    <div class="flex items-center justify-between">
                                                                        <span class="text-xs text-base-content/60">Получит трейдер</span>
                                                                    ...
                                                                    <div class="flex items-center justify-between">
                                                                        ...
                                                                        <span class="font-semibold">{{ formatCalcMoney(getCalcValue(payout, 'split', 'from_service'), 'USDT') }}</span>
                                                                    </div>
                                                                    <div class="flex items-center justify-between">
                                                                        <span class="text-xs text-base-content/60">Из трейдера</span>
                                                                        <span class="font-semibold">{{ formatCalcMoney(getCalcValue(payout, 'split', 'from_trader'), 'USDT') }}</span>
                                                                    </div>
                                                                    <div class="flex items-center justify-between">
                                                            ...
                                                            <div class="collapse collapse-arrow border border-base-200 bg-base-200/40 rounded-box">
                                                                ...
                                                                <div class="collapse-content">
                                                                    <pre class="text-xs whitespace-pre-wrap bg-base-200/70 p-3 rounded-box">{{ formatMeta(payout.calc_meta) }}</pre>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                ...
                                <transition name="fade">
                                    <div v-if="isExpanded(payout.id)" class="space-y-4">
                                        ...
                                        <div class="collapse collapse-arrow border border-base-200 bg-base-200/40 rounded-box">
                                            <input type="checkbox" />
                                            <div class="collapse-title text-sm font-semibold">
                                                Математика (calc meta)
                                            </div>
                                            <div class="collapse-content text-sm space-y-3">
                                                <div class="text-xs uppercase text-base-content/50">Входные данные</div>
                                                <div class="flex items-center justify-between">
                                                    <span>Сумма</span>
                                                    <span class="font-semibold">{{ formatCalcMoney(getCalcValue(payout, 'inputs', 'amount_fiat'), getCalcAmountCurrency(payout)) }}</span>
                                                </div>
                                                <div class="flex items-center justify-between">
                                                    <span>Комиссия всего</span>
                                                    <span class="font-semibold">{{ getCalcValue(payout, 'inputs', 'total_commission_rate') ?? '—' }}%</span>
                                                </div>
                                                <div class="flex items-center justify-between">
                                                    <span>Комиссия трейдера</span>
                                                    <span class="font-semibold">{{ getCalcValue(payout, 'inputs', 'trader_commission_rate') ?? '—' }}%</span>
                                                </div>
                                                <div class="flex items-center justify-between">
                                                    <span>Комиссия тимлида</span>
                                                    <span class="font-semibold">{{ getCalcValue(payout, 'inputs', 'teamlead_commission_rate') ?? '—' }}%</span>
                                                </div>
                                                <div class="flex items-center justify-between">
                                                ...
                                                <div class="flex items-center justify-between">
                                                    <span>Цена</span>
                                                    <span class="font-semibold">{{ formatCalcMoney(getCalcValue(payout, 'exchange', 'price'), getCalcCurrency(payout)) }}</span>
                                                </div>
                                                <div class="flex items-center justify-between">
                                                ...
                                                <div class="divider my-1"></div>
                                                <div class="text-xs uppercase text-base-content/50">Выходные суммы (USDT)</div>
                                                <div class="flex items-center justify-between"><span>Тело</span><span class="font-semibold">{{ formatCalcMoney(getCalcValue(payout, 'outputs', 'usdt_body'), 'USDT') }}</span></div>
                                                <div class="flex items-center justify-between"><span>Комиссия всего</span><span class="font-semibold">{{ formatCalcMoney(getCalcValue(payout, 'outputs', 'total_fee'), 'USDT') }}</span></div>
                                                <div class="flex items-center justify-between"><span>Комиссия трейдера (база)</span><span class="font-semibold">{{ formatCalcMoney(getCalcValue(payout, 'outputs', 'trader_fee_base'), 'USDT') }}</span></div>
                                                <div class="flex items-center justify-between"><span>Комиссия трейдера (итог)</span><span class="font-semibold">{{ formatCalcMoney(getCalcValue(payout, 'outputs', 'trader_fee'), 'USDT') }}</span></div>
                                                <div class="flex items-center justify-between"><span>Комиссия тимлида</span><span class="font-semibold">{{ formatCalcMoney(getCalcValue(payout, 'outputs', 'teamlead_fee'), 'USDT') }}</span></div>
                                                <div class="flex items-center justify-between"><span>Комиссия сервиса (база)</span><span class="font-semibold">{{ formatCalcMoney(getCalcValue(payout, 'outputs', 'service_fee_base'), 'USDT') }}</span></div>
