    ...
    <div>
        ...
        <div class="mx-auto space-y-6">
            <div class="flex justify-between items-center">
                <h2 class="text-3xl font-bold text-base-content">Главная</h2>
                ...
                <section class="space-y-8">
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-3 2xl:grid-cols-3 gap-6">
                        ...
                        <div class="card bg-base-100 shadow p-6">
                            <div class="flex items-center justify-between">
                                <div>
                                    <p class="text-base-content/70 text-lg">Комиссия</p>
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                        ...
                        <div class="card bg-base-100 shadow p-6">
                            <div class="flex items-center justify-between">
                                <div>
                                    <p class="text-base-content/70 text-lg">Трейдеров</p>
