                        ...
                        <div class="overflow-x-auto card bg-base-100 shadow">
                            <table class="table table-md">
                                ...
                                <tr v-for="order in orders.data" class="bg-base-100 border-b last:border-none">
                                    ...
                                    <td class="px-0 py-3">
                                        <div>
                                            <div v-if="order.is_h2h" class="badge badge-outline">H2H</div>
                                            <div v-else class="badge badge-neutral">Merchant</div>
                                        </div>
                                    </td>
                                    <td class="text-right">
                                ...
                                <div class="card-body p-4 pt-2 pb-3">
                                    ...
                                    <div v-show="!!expandedCards[order.id]" class="mt-3 flex flex-col gap-2 bg-base-300/50 rounded-box p-2">
                                        <div class="flex flex-col gap-2">
                                            ...
                                            <button
                                                class="btn btn-sm btn-outline w-full"
                                                @click="router.post(route('merchant-support.payment.callback.resend', order.id))"
                                            >
                                                Отправить Callback
                                            </button>
                                        </div>
