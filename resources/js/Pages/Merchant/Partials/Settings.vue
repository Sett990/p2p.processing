                        ...
                        >
                            <div class="rounded-plate bg-white shadow text-sm font-semibold py-2 px-3 dark:bg-gray-800">
                                ...
                                <div v-if="gatewayEditMode === true" class="flex items-center mt-2">
                                    ...
                                    <input style="rotate: 180deg" type="range" v-model="gatewaySettings[gateway.id]['merchant_commission']" min="0" :max="gateway.service_commission_rate" step="0.1" class="w-full h-1 bg-gray-200 rounded-xl appearance-none cursor-pointer range-sm dark:bg-gray-700">
