                        ...
                        >
                            <div class="rounded-plate bg-white shadow text-sm font-semibold py-2 px-3 dark:bg-gray-800">
                                <div class="flex justify-between items-center">
                                    ...
                                    <div class="text-xl" :class="gatewaySettings[gateway.id]['active'] ? 'text-gray-900 dark:text-gray-200' : 'text-red-700 dark:text-red-400'">
                                ...
                                <div v-if="gatewayEditMode === true" class="flex items-center mt-2">
                                    ...
                                    <input style="rotate: 180deg" type="range" v-model="gatewaySettings[gateway.id]['merchant_commission']" min="0" :max="gateway.order_service_commission_rate" step="0.1" class="w-full h-1 bg-gray-200 rounded-xl appearance-none cursor-pointer range-sm dark:bg-gray-700">
