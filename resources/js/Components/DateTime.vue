...
<template>
    <div>
        <div
            class="flex items-center gap-2 text-nowrap cursor-pointer"
        ...
        <div :id="'tooltip'+$.uid" role="tooltip" class="tooltip tooltip-open" :data-tip="copied ? 'Скопировано!' : 'Скопировать'"></div>
    </div>
</template>
