...
<template>
    <div>
        <div
            class="flex items-center gap-2 text-nowrap hover:cursor-pointer"
            :data-tooltip-target="'tooltip'+$.uid"
            @click.prevent="copy(data)"
        >
            <svg class="h-4 w-4 text-gray-900 dark:text-gray-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
