...
<!--                <span class="badge justify-self-end">7</span>-->
        ...
        <li :class="[{ 'bg-base-content/10 rounded-lg': route().current('admin.cascade.*') }]">
            <span
                @click="router.visit(route('admin.cascade.index'), { preserveScroll: true })"
                @keydown.enter.space="router.visit(route('admin.cascade.index'), { preserveScroll: true })"
                role="link"
                tabindex="0"
            >
                <svg class="size-5 opacity-30" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
        ...
        <li :class="[{ 'bg-base-content/10 rounded-lg': route().current('admin.payouts.*') }]">
            <span
                @click="router.visit(route('admin.payouts.index'), { preserveScroll: true })"
                @keydown.enter.space="router.visit(route('admin.payouts.index'), { preserveScroll: true })"
                role="link"
                tabindex="0"
            >
                <svg class="size-5 opacity-30" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
        ...
        <li :class="[{ 'bg-base-content/10 rounded-lg': route().current('admin.withdrawals.*') }]">
            ...
            >
                ...
                Вывод средств
                <span v-if="menu.pendingWithdrawals" class="badge badge-warning badge-sm justify-self-end">
...
<!--        <li :class="[{ 'bg-base-content/10 rounded-lg': route().current('admin.profit-calculator.*') }]">
            <span
                @click="router.visit(route('admin.profit-calculator.index'), { preserveScroll: true })"
                @keydown.enter.space="router.visit(route('admin.profit-calculator.index'), { preserveScroll: true })"
                role="link"
                tabindex="0"
            >
                <svg class="size-5 opacity-30" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
        ...
        <li :class="[{ 'bg-base-content/10 rounded-lg': route().current('admin.anti-fraud.*') }]">
            ...
            >
                <svg class="size-5 opacity-30" stroke-width="1.5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 2 4 5v6c0 5.55 3.84 10.74 8 11 4.16-.26 8-5.45 8-11V5l-8-3Zm0 7v3m0 4h.01"/>
                </svg>
                Антифрод
            </span>
        </li>
...
<!--        <li>
            <span
                ...
                tabindex="0"
            >
                <svg class="size-5 opacity-30" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
